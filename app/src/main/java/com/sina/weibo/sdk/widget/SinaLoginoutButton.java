 ...
 * @since 2013-11-04
 */
public class SinaLoginoutButton extends Button implements OnClickListener {
     ...
     */
    public SinaLoginoutButton(Context context, AttributeSet attrs) {
     ...
     */
    public SinaLoginoutButton(Context context, AttributeSet attrs, int defStyle) {
